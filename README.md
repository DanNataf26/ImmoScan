...
## Mise à jour v0.3 — séparation historique / comparables / score opportunité

Cette version évite le doublon entre les deux tableaux DVF :

- **Historique probable du bien** : se concentre sur les ventes qui ressemblent le plus à l'adresse saisie, avec date, prix, évolution et durée de détention approximative.
- **Marché comparable autour du bien** : affiche les ventes similaires à proximité, filtrées par type de bien, avec distance, surface, prix et prix au m².
- **Score opportunité ImmoScan** : calcule un score simple sur 100 à partir de la décote/surcote locale, du nombre de comparables, de l'historique retrouvé et du DPE lorsque disponible.

Pour utiliser le score, renseignez dans l'onglet **Adresse + vues** :

1. l'adresse ;
2. le type de bien ;
3. la surface de l'annonce ;
4. le prix affiché.

Le score reste une aide à la décision : il ne remplace pas la vérification de l'état du bien, des travaux, du règlement de copropriété, du PLU, du financement ni des contraintes locatives.
